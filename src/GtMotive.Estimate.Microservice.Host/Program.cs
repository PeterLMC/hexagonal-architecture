...
BsonSerializer.RegisterSerializer(new ManufactureDateSerializer());
...
{
    var vehicleSeed = scope.ServiceProvider.GetRequiredService<VehicleSeed>();
    await vehicleSeed.SeedAsync();
}
